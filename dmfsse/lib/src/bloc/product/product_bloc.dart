...
class ProductBloc extends Bloc<ProductEvent,ProductState>  {
  ...
  ProductBloc(this.productDataRepository):super(InitialState()) {
    on<ProductEvent>((event, emit)  async{
      ...
      bool isProductCreated = await productDataRepository.addProduct(event.product);
      ...
      if(isProductCreated){
       ...
       if(event is FetchAllProduct){
        ...
        try {
          final List<Product> productDetail =  await productDataRepository.getAllActiveProduct();
