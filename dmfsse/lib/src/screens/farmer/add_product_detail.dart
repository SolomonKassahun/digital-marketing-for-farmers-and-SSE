                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  product.description = descriptionController.text.toString();
                                  product.price = priceController.text.toString();
                                  product.photos = productPhotos.text.toString();
                                  print("======================");
                                  print('${productPhotos.text},${titleController.text}');
                                ...
                                child: isRegister? const CircularProgressIndicator(color: Colors.white,) :const Text("Add Product")
                                ),
                          ),
                        ],
                      )),
